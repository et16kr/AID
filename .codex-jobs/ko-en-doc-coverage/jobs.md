...
| `J005` | `Done` | Technical docs: development and API integrations | Compare Korean DOCK developer, precompiler, APRE, Java, ODBC, ADO.NET, Spring, iBATIS, MyBatis, Hibernate, PHP, WAS integration, and client tool documents against English arch documents, then update English from Korean where needed. |
| `J006` | `Done` | Technical docs: SQL, tuning, migration, conversion, and tools | Compare Korean DOCK development guide, SQL tuning, Oracle/MSSQL conversion, data migration, Docker, GeoServer, SQuirrel, VC guides, and Migration Center documents against English arch documents, then update English from Korean where needed. |
| `J007` | `Done` | FAQ docs: installation, operation, and management | Compare Korean faq categories 01 and 02 against the corresponding FAQE core categories, then update English from Korean where needed. |
| `J008` | `Done` | FAQ docs: replication, backup, SQL, stored procedures, and development API | Compare Korean faq categories 03, 04, 05, 06, and 07 against the corresponding FAQE core categories, then update English from Korean where needed. |
| `J009` | `Done` | FAQ docs: monitoring, error messages, utilities, others, and general | Compare Korean faq categories 08, 09, 11, 12, and 13 against the corresponding FAQE core categories, then update English from Korean where needed. |
