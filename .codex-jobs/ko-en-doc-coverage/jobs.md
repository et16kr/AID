...
| --- | --- | --- | --- |
| `J001` | `ToDo` | Baseline inventory and mapping | Confirm requirements, current git state, document counts, Korean-English mappings, FAQ category mappings, and attachment inventory before content review. |
