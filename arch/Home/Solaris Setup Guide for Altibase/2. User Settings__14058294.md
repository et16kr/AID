...
| PATH | Adds `ALTIBASE_HOME/bin` so Altibase binaries and shell scripts can be used regardless of the current path. |
...
| --- | --- |
| LD_LIBRARY_PATH_64 | Set this when linking dynamic libraries in 64-bit mode. |
