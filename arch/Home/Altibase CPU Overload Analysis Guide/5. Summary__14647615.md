...
- [5.1 Step-by-step inspection method](#id-5.Summary-5.1Step-by-stepinspectionmethod) - [5.1 Data collection for analysis](#id-5.Summary-5.1Datacollectionforanalysis) - [5.2 Cause analysis](#id-5.Summary-5.2Causeanalysis) - [5.2.1 Check whether it is related to the impact of application change](#id-5.Summary-5.2.1Checkwhetheritisrelatedtotheimpactofapplicationchange) - [5.2.2 Relevance to data increase and check whether there is any change in the query plan](#id-5.Summary-5.2.2Relevancetodataincreaseandcheckwhetherthereisanychangeinthequeryplan) - [5.2.3 Mismatch of DB and application character set](#id-5.Summary-5.2.3MismatchofDBandapplicationcharacterset) - [5.2.4 Increase of service thread](#id-5.Summary-5.2.4Increaseofservicethread) - [5.2.5 Effect of OS environment variables](#id-5.Summary-5.2.5EffectofOSenvironmentvariables) - [5.2.6 Frequent DB connection attempts](#id-5.Summary-5.2.6FrequentDBconnectionattempts) - [5.2 Navigation with OS utility](#id-5.Summary-5.2NavigationwithOSutility)
