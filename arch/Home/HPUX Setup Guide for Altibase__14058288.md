---
title: "HPUX Setup Guide for Altibase"
page_id: "14058288"
space_key: "arch"
space_name: "Technical Documents(English)"
source_url: "https://docs.altibase.com/display/arch/HPUX+Setup+Guide+for+Altibase"
updated_at: "2025-09-23T08:41:23.000+0900"
version: 8
ancestors: ["Home"]
labels: []
---
...
Source: https://docs.altibase.com/display/arch/HPUX+Setup+Guide+for+Altibase
Updated: 2025-09-23T08:41:23.000+0900

- [Overview](#HPUXSetupGuideforAltibase-Overview) - [Kernel Parameters](#HPUXSetupGuideforAltibase-KernelParameters) - [User Settings](#HPUXSetupGuideforAltibase-UserSettings) - [Multi-Thread Related Patch](#HPUXSetupGuideforAltibase-Multi-ThreadRelatedPatch) - [Summary](#HPUXSetupGuideforAltibase-Summary)
...
| Kernel Parameter | Description | Recommended Value |
| --- | --- | --- |
| dbc_min_pct | Limits the minimum size of the file cache to a percentage of total memory. The default value is 5%.<br>Since HPUX 11.31, the name is changed to filecache_min. | 5% |
...
| Resource limit | maxdsiz | 2GB | Corresponds to data seg size (32bit) |
| Resource limit | maxdsiz_64bit | 1 TB / Maximum: around 4TB | Corresponds to data seg size (64bit) |
