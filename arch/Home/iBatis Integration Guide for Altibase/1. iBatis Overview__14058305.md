...
In previous iBATIS versions, ibatis-comm.jar and ibatis-sqlmap.jar were required. In iBATIS 2.3.4, those files were consolidated into ibatis-2.3.4.x.jar. This document uses ibatis-2.3.4.726.jar.
