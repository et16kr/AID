...
To integrate ALTIBASE HDB with PHP in a Unix or Windows environment, the ODBC manager must be installed first. This section describes how to install the ODBC manager and configure the environment for Unix, Linux, and Windows.
