...
- Operations can be done in the CONTROL stage
  ...
  The operations that the user can perform in the CONTROL stage are as follows.
    ...
    - Retrieve performance view The performance view can be retrieved in the PROCESS stage and the following performance view can be retrieved additionally. (Normal tables cannot be retrieved.)
      ...
      | V$OBSOLETE_BACKUP_INFO | Information on backups that are no longer need to maintain (As part of V$BACKUP_INFO, refer to V$BACKUP_INFO information for details) |
...
- Operations can be done in the META stage
  ...
  The operations that users can p[perform in the META stage are as follows.
