...
| Data-source-class-name | The data source class name by JDBC driver<br>**ABConnectionPoolDataSource ( ALTIBASE 6.1.1 or lower),**<br>**AltibaseConnectionPoolDataSource ( ALTIBASE 6.3.1 or later) ,**<br>This decides how to set BlackboxConnectionPoolDataSource. |
