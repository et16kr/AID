...
| [http://server_ip:port](http://server_ipport) number/WAR name/jsp file name Example) [http://localhost:8080/AltiTest/test.jsp](http://localhost:8080/AltiTest/test.jsp) |
| --- |
