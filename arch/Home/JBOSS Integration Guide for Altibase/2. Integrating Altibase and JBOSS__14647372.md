...
Failover is a function to provide continuous service by detecting a failure of a DBMS in use and switching to another DBMS to prevent service interruption due to a DBMS failure.
